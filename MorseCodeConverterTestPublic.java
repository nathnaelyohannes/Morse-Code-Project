...
public class MorseCodeConverterTestPublic {
	...
	@Test
	public void testConvertToEnglishStringAnother() {
		String another = "- .... .. ... / .. ... / .- / - . ... -";
		String sentence = "this is a test";
		assertEquals(sentence, MorseCodeConverter.convertToEnglish(another));
	}
	
	@Test
	public void testConvertMorseFileToEnglishStringAnother() {
		File another = new File("src/another.txt");
		try {
			assertEquals("this is a test", MorseCodeConverter.convertToEnglish(another));
		} catch (FileNotFoundException e) {
